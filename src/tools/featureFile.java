...
public class featureFile extends File {
	...
	public featureFile(String arg0,positions positions) throws FileNotFoundException {
		...
		while(sc.hasNext()){
			...
			featureArrayList.add(new feature(split[3],Integer.parseInt(split[1]), Integer.parseInt(split[2]),featType,positions));
	...
	public String getHTML(int start,int size,String input_seq_type){
