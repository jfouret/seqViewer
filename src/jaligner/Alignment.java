...
public final class Alignment {
	...
	public String getSummary() {
		...
		buffer.append("Length Reference: " + getOriginalSequence1().length());
		buffer.append(Commons.getLineSeparator());
		buffer.append("Length Uniprot: " + getOriginalSequence2().length());
		buffer.append(Commons.getLineSeparator());
		...
		buffer.append(Commons.getLineSeparator());
		buffer.append("Mismatches: " + (length-identity-gaps) + "/" + length + " ("
				+ f2.format((length-identity-gaps) / (float) length) + ")");
		buffer.append(Commons.getLineSeparator());
